...
[](https://bionano.autodesk.com/BioMod/Assets/Logo.jpeg)

What is this circle about anyway? To summarize, what we do is we are trying to create molecular machines or structures using DNA and join the international competition held in UCSF (previously Harvard), and is organized by Wyss institute of Harvard. We meet about once a week, depends on the members empty slot, this semester it was decided to be every Friday from around 5pm in Suita campus (gotta rush and ride the 4.20blaze itbus from Toyonaka campus).
